...
abs1 = Observation.create!(obs_date: Date.new(2021,9,21), category: "Absence", note: "", obs_color: "Red", student: slamy, user: gjing)
...
abs2 = Observation.create!(obs_date: Date.new(2021,11,26), category: "Absence", note: "", obs_color: "Red", student: slamy, user: gjing)
abs3 = Observation.create!(obs_date: Date.new(2021,12,7), category: "Absence", note: "", obs_color: "Red", student: slamy, user: gjing)
