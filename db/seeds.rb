...
relation1 = Observation.create!(obs_date: Date.new(2021,9,10), category: "Relation à l'autre", note: "Pleure mis en groupe avec Lucas", obs_color: "Difficultés", student: chumbert, user: gjing)
relation2 = Observation.create!(obs_date: Date.new(2021,9,28), category: "Relation à l'autre", note: "Attend plusieurs minutes poru sortir de la classe", obs_color: "Neutre", student: chumbert, user: gjing)
relation3 = Observation.create!(obs_date: Date.new(2021,9,28), category: "Relation à l'autre", note: "Est en conflit avec les autres", obs_color: "Difficultés", student: lrodriguez, user: gjing)
relation4 = Observation.create!(obs_date: Date.new(2021,10,11), category: "Relation à l'autre", note: "Est réfractaire à l'apprentissage, refuse d'apprendre", obs_color: "Difficultés", student: lrodriguez, user: gjing)
relation5 = Observation.create!(obs_date: Date.new(2021,10,12), category: "Relation à l'autre", note: "A envie de participer mais n'ose pas (lève la main puis ne participe pas)", obs_color: "Neutre", student: cteissier, user: gjing)
relation6 = Observation.create!(obs_date: Date.new(2021,11,29), category: "Relation à l'autre", note: "Ne participe pas, mais suit en classe", obs_color: "Forces", student: cteissier, user: gjing)
expression1 = Observation.create!(obs_date: Date.new(2021,11,02), category: "Expression", note: "Ne réagit pas aux injonctions, aux demandes orales", obs_color: "Difficultés", student: lrodriguez, user: gjing)
expression2 = Observation.create!(obs_date: Date.new(2021,11,2), category: "Expression", note: "Parle à voix basse, est peu audible", obs_color: "Neutre", student: cteissier, user: gjing)
expression3 = Observation.create!(obs_date: Date.new(2021,10,25), category: "Expression", note: "Restituer oralement une leçon", obs_color: "Forces", student: ieurtein, user: gjing)
attitude1 = Observation.create!(obs_date: Date.new(2021,12,15), category: "Attitudes corporelles", note: "A une grande fatigabilité", obs_color: "Neutre", student: cteissier, user: gjing)
gestesquotidiens1 = Observation.create!(obs_date: Date.new(2021,12,7), category: "Gestes / actes quotidiens", note: "Se repère dans l'espace avec difficulté (tableau, graphique, cahier, dictionnaire...)", obs_color: "Difficultés", student: cteissier, user: gjing)
ecriture1 = Observation.create!(obs_date: Date.new(2021,10,11), category: "Ecriture", note: "Ne fixe pas l'orthographe des mots", obs_color: "Difficultés", student: gmakalu, user: gjing)
lecture1 = Observation.create!(obs_date: Date.new(2021,12,15), category: "Lecture", note: "Ne comprend pas l'implicite, le second degrés, le sens figuré...", obs_color: "Difficultés", student: lrodriguez, user: gjing)
math1 = Observation.create!(obs_date: Date.new(2021,11,2), category: "Mathématiques", note: "Accède difficilement au calcul mental", obs_color: "Neutre", student: cteissier, user: gjing)
comportement1 = Observation.create!(obs_date: Date.new(2021,12,15), category: "Comportement", note: "A un principe de réalité erroné (la récréation dure deux semaines)", obs_color: "Neutre", student: lrodriguez, user: gjing)
environnement1 = Observation.create!(obs_date: Date.new(2021,10,11), category: "Environnement", note: "Devoirs non-faits", obs_color: "Difficultés", student: lrodriguez, user: gjing)
autre1 = Observation.create!(obs_date: Date.new(2021,12,15), category: "Autre", note: "Parents ne viennent pas aux convocations", obs_color: "Difficultés", student: lrodriguez, user: gjing)
abs1 = Observation.create!(obs_date: Date.new(2021,9,21), category: "Absence", note: "", obs_color: "Difficultés", student: slamy, user: gjing)
b1 = Observation.create!(obs_date: Date.new(2021,10,13), category: "Relation à l'autre", note: "Grand politesse", obs_color: "Forces", student: slamy, user: gjing)
abs2 = Observation.create!(obs_date: Date.new(2021,11,26), category: "Absence", note: "", obs_color: "Difficultés", student: slamy, user: gjing)
abs3 = Observation.create!(obs_date: Date.new(2021,12,7), category: "Absence", note: "", obs_color: "Difficultés", student: slamy, user: gjing)
b2 = Observation.create!(obs_date: Date.new(2021,10,11), category: "Relation à l'autre", note: "S'occupe bien de ses camarades", obs_color: "Forces", student: ipetit, user: gjing)
b3 = Observation.create!(obs_date: Date.new(2021,11,14), category: "Environnement", note: "Vient à vélo", obs_color: "Forces", student: slamy, user: gjing)
b4 = Observation.create!(obs_date: Date.new(2021,12,15), category: "Environnement", note: "Devoirs parfaits", obs_color: "Forces", student: slamy, user: gjing)
b5 = Observation.create!(obs_date: Date.new(2021,11,2), category: "Expression", note: "Bonne expression", obs_color: "Forces", student: ipetit, user: gjing)
b6 = Observation.create!(obs_date: Date.new(2021,12,15), category: "Relation à l'autre", note: "Participe à la bonne ambiance de la classe", obs_color: "Forces", student: ipetit, user: gjing)
