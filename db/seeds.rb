...
epetit = Student.create!(first_name: 'Isabelle', last_name: 'Petit', classroom: ce1)
epetit.photo.attach(io: img_isabelle, filename: 'Isabelle_s98zgg', content_type: 'image/jpg')
...
slamy.photo.attach(io: img_sarah, filename: 'Sarah_ms6exd.jpg', content_type: 'image/jpg')
...
relation1 = Observation.create!(obs_date: 20210920, category: "Relation à l'autre", note: "Pleure mis en groupe avec Lucas", obs_color: "Red", student: chumbert, user: gjing)
relation2 = Observation.create!(obs_date: 20210928, category: "Relation à l'autre", note: "Attend plusieurs minutes poru sortir de la classe", obs_color: "Grey", student: chumbert, user: gjing)
relation3 = Observation.create!(obs_date: 20210928, category: "Relation à l'autre", note: "Est en conflit avec les autres", obs_color: "Red", student: lrodriguez, user: gjing)
relation4 = Observation.create!(obs_date: 20211011, category: "Relation à l'autre", note: "Est réfractaire à l'apprentissage, refuse d'apprendre", obs_color: "Red", student: lrodriguez, user: gjing)
relation5 = Observation.create!(obs_date: 20211012, category: "Relation à l'autre", note: "A envie de participer mais n'ose pas (lève la main puis ne participe pas)", obs_color: "Grey", student: cteissier, user: gjing)
relation6 = Observation.create!(obs_date: 20211129, category: "Relation à l'autre", note: "Ne participe pas, mais suit en classe", obs_color: "Green", student: cteissier, user: gjing)
expression1 = Observation.create!(obs_date: 20211102, category: "Expression", note: "Ne réagit pas aux injonctions, aux demandes orales", obs_color: "Red", student: lrodriguez, user: gjing)
expression2 = Observation.create!(obs_date: 20211102, category: "Expression", note: "Parle à voix basse, est peu audible", obs_color: "Grey", student: cteissier, user: gjing)
expression3 = Observation.create!(obs_date: 20211025, category: "Expression", note: "Restituer oralement une leçon", obs_color: "Green", student: ieurtein, user: gjing)
attitude1 = Observation.create!(obs_date: 20211215, category: "Attitudes corporelles", note: "A une grande fatigabilité", obs_color: "Grey", student: cteissier, user: gjing)
gestesquotidiens1 = Observation.create!(obs_date: 20211207, category: "Gestes / actes quotidiens", note: "Se repère dans l'espace avec difficulté (tableau, graphique, cahier, dictionnaire...)", obs_color: "Red", student: cteissier, user: gjing)
ecriture1 = Observation.create!(obs_date: 20211011, category: "Ecriture", note: "Ne fixe pas l'orthographe des mots", obs_color: "Red", student: gmakalu, user: gjing)
lecture1 = Observation.create!(obs_date: 20211215, category: "Lecture", note: "Ne comprend pas l'implicite, le second degrés, le sens figuré...", obs_color: "Red", student: lrodriguez, user: gjing)
math1 = Observation.create!(obs_date: 20211102, category: "Mathématiques", note: "Accède difficilement au calcul mental", obs_color: "Grey", student: cteissier, user: gjing)
